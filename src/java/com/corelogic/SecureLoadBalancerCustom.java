...
/**
 * Secure Load Balancing Demo (Interactive, Java 1.8 compatible)
 * - Round-Robin, Throttled, Dynamic Routing
 * - AES-GCM encryption
 */
public class SecureLoadBalancerCustom {
    ...
    // ===== Helper: Safe truncation for preview =====
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Enter your data payload text:");
        ...
        System.out.println("3. Dynamic Routing");
        ...
        List<String> parts = lb.partitionData(payload, partsCount);
        Map<VMNode, String> assignments = null;

        switch (choice) {
            case 1:
                assignments = lb.roundRobinAssign(parts);
                System.out.println("\n=== Round Robin ===");
                break;
            case 2:
                assignments = lb.throttledAssign(parts);
                System.out.println("\n=== Throttled ===");
                break;
            case 3:
                assignments = lb.dynamicRoutingAssign(parts);
                System.out.println("\n=== Dynamic Routing ===");
                break;
            default:
        ...
        for (Map.Entry<VMNode, String> e : assignments.entrySet()) {
            System.out.println(e.getKey().id + " -> " +
                    truncate(lb.decryptPayload(e.getValue()), 40));
        }
